...
!!
!! CHILDREN
!!      destroy_rf_hamiltonian,dotprod_g,dotprod_vn,getcprj,getgsc
!!      init_rf_hamiltonian,initylmg,load_k_hamiltonian,load_k_rf_hamiltonian
!!      load_spin_hamiltonian,load_spin_rf_hamiltonian,mkffnl,mkkin,mkkpg
!!      nonlop,paw_dfptnl_accrhoij,paw_dfptnl_energy,paw_ij_free,paw_ij_init
...
!!      pawrhoij_free,pawrhoij_init_unpacked,pawrhoij_mpisum_unpacked
!!      pawrhoij_nullify,rf2_apply_hamiltonian,rf2_getidir
!!      rf_transgrid_and_pack,status,wfk_read_bks,wrtout,xmpi_sum
!!
!! SOURCE
