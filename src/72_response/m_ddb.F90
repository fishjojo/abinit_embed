...
!!
!! PARENTS
!!      anaddb,m_ddb,m_ddb_interpolate,m_dfpt_looppert
!!      m_effective_potential_file,m_eph_driver,m_gruneisen,m_gstate,m_ifc
!!      m_thmeig
!!
!! CHILDREN
...
!!
!! PARENTS
!!      m_ddb,m_ddb_interpolate,m_gstate,m_thmeig
!!
!! CHILDREN
!!      ddb_free,ddb_hdr_compare,ddb_hdr_free,ddb_hdr_open_read
!!      ddb_hdr_open_write,ddb_malloc,ddb_write_blok,read_blok8,wrtout
...
!!
!! PARENTS
!!      anaddb,m_ddb,m_ddb_interpolate,m_effective_potential_file,m_phonons
!!      m_thmeig
!!
!! CHILDREN
!!      ddb_free,ddb_hdr_compare,ddb_hdr_free,ddb_hdr_open_read
...
!!
!! PARENTS
!!      anaddb,m_dfpt_looppert,m_effective_potential_file,m_eph_driver
!!      m_gruneisen,m_ifc
!!
!! CHILDREN
!!      ddb_free,ddb_hdr_compare,ddb_hdr_free,ddb_hdr_open_read
...
!!
!! PARENTS
!!      anaddb,m_ddb,m_ddb_interpolate,m_phonons
!!
!! CHILDREN
!!      ddb_free,ddb_hdr_compare,ddb_hdr_free,ddb_hdr_open_read
!!      ddb_hdr_open_write,ddb_malloc,ddb_write_blok,read_blok8,wrtout
...
!!
!! PARENTS
!!      m_ddb,m_ddb_interpolate,m_gstate
!!
!! CHILDREN
!!      ddb_free,ddb_hdr_compare,ddb_hdr_free,ddb_hdr_open_read
!!      ddb_hdr_open_write,ddb_malloc,ddb_write_blok,read_blok8,wrtout
