...
!!
!! PARENTS
!!      m_d2frnl,m_dfpt_nstwf,m_dfpt_scfcv,m_dfpt_vtorho,m_dfptnl_loop
!!      m_dft_energy,m_fock_getghc,m_forstr,m_gkk,m_gwls_hamiltonian,m_io_kss
...
!! PARENTS
!!      m_d2frnl,m_dfpt_nstwf,m_dfpt_scfcv,m_dfpt_vtorho,m_dfptnl_loop
!!      m_dft_energy,m_fock_getghc,m_forstr,m_gkk,m_io_kss,m_ksdiago
...
!!
!! PARENTS
!!      m_d2frnl,m_dfpt_nstwf,m_dfpt_scfcv,m_dfptnl_pert,m_dft_energy
!!      m_fock_getghc,m_forstr,m_getgh1c,m_gwls_hamiltonian,m_io_kss,m_ksdiago
!!      m_nonlop_test,m_orbmag,m_pead_nl_loop,m_rf2,m_vtorho
!!
!! CHILDREN
!!      free_my_atmtab,get_my_atmtab,xmpi_sum
!!
...
!!
!! PARENTS
!!      m_dfpt_nstwf,m_dfpt_scfcv,m_fock_getghc,m_getgh1c
!!
!! CHILDREN
!!      free_my_atmtab,get_my_atmtab,xmpi_sum
!!
...
!!
!! PARENTS
!!      m_d2frnl,m_dfpt_nstwf,m_dfpt_scfcv,m_dfpt_vtorho,m_dfptnl_pert
!!      m_dft_energy,m_fock_getghc,m_forstr,m_gkk,m_io_kss,m_ksdiago
!!      m_nonlop_test,m_orbmag,m_phgamma,m_phpi,m_sigmaph,m_vtorho
!!
!! CHILDREN
!!      free_my_atmtab,get_my_atmtab,xmpi_sum
!!
...
!!
!! PARENTS
!!      m_dfpt_nstwf,m_dfpt_scfcv,m_dfpt_vtorho,m_dfptnl_pert,m_gkk,m_phgamma
!!      m_phpi,m_sigmaph
!!
!! CHILDREN
!!      free_my_atmtab,get_my_atmtab,xmpi_sum
...
!!
!! PARENTS
!!      m_dfpt_scfcv,m_dfpt_vtorho,m_dfptnl_pert,m_gkk,m_phgamma,m_phpi
!!      m_sigmaph
!!
!! CHILDREN
!!      free_my_atmtab,get_my_atmtab,xmpi_sum
...
!!
!! PARENTS
!!      m_dfpt_nstwf,m_dfpt_scfcv,m_dfptnl_pert,m_getgh1c
!!
!! CHILDREN
!!      free_my_atmtab,get_my_atmtab,xmpi_sum
!!
