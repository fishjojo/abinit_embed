...
!!
!! PARENTS
!!      anaddb,m_anharmonics_terms,m_compute_anharmonics,m_effective_potential
!!      m_effective_potential_file,m_eph_driver,m_generate_training_set
!!      m_gruneisen,m_harmonics_terms,m_ifc
!!
!! CHILDREN
...
!!
!! PARENTS
!!      anaddb,m_eph_driver,m_tdep_abitypes
!!
!! CHILDREN
!!      dfpt_phfrq,gtdyn9,nctk_defwrite_nonana_terms
!!
...
!!
!! PARENTS
!!      m_a2ftr,m_elphon,m_gkk,m_gruneisen,m_harmonic_thermo,m_ifc,m_iogkk
!!      m_phgamma,m_phonons,m_phpi,m_sigmaph,m_tdep_phdos
!!
!! CHILDREN
!!      dfpt_phfrq,gtdyn9,nctk_defwrite_nonana_terms
!!
...
!!
!! PARENTS
!!      m_frohlichmodel,m_gruneisen,m_phonons
!!
!! CHILDREN
!!      dfpt_phfrq,gtdyn9,nctk_defwrite_nonana_terms
!!
