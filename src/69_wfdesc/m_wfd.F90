...
!!      m_sigma_driver,m_sigmaph,m_wfd,m_wfk_analyze
!!
!! CHILDREN
!!      pawaccrhoij,pawcprj_alloc,pawcprj_free,pawio_print_ij
!!      pawrhoij_mpisum_unpacked,wfd_bks_distrb,wfd_get_cprj,wrtout
...
!!
!! PARENTS
!!      m_bethe_salpeter,m_gkk,m_phgamma,m_phpi,m_screening_driver
...
!!
!! PARENTS
!!      m_bethe_salpeter,m_sigma_driver
!!
!! CHILDREN
!!      pawaccrhoij,pawcprj_alloc,pawcprj_free,pawio_print_ij
!!      pawrhoij_mpisum_unpacked,wfd_bks_distrb,wfd_get_cprj,wrtout
...
!!
!! PARENTS
!!      m_chi0,m_classify_bands,m_cohsex,m_exc_analyze,m_exc_build
!!      m_prep_calc_ucrpa,m_sigc,m_sigx,m_vhxc_me,m_wfd
!!
!! CHILDREN
!!      pawaccrhoij,pawcprj_alloc,pawcprj_free,pawio_print_ij
!!      pawrhoij_mpisum_unpacked,wfd_bks_distrb,wfd_get_cprj,wrtout
...
!!
!! PARENTS
!!      m_chi0,m_sigma,m_sigma_driver,m_wfd
!!
!! CHILDREN
!!      pawaccrhoij,pawcprj_alloc,pawcprj_free,pawio_print_ij
!!      pawrhoij_mpisum_unpacked,wfd_bks_distrb,wfd_get_cprj,wrtout
...
!!
!! PARENTS
!!      m_chi0,m_cohsex,m_exc_build,m_prep_calc_ucrpa,m_sigc,m_sigma_driver
!!      m_sigx,m_vhxc_me,m_wfd,m_wfd_optic
!!
!! CHILDREN
!!      pawaccrhoij,pawcprj_alloc,pawcprj_free,pawio_print_ij
!!      pawrhoij_mpisum_unpacked,wfd_bks_distrb,wfd_get_cprj,wrtout
...
!!
!! PARENTS
!!      m_bseinterp,m_chi0,m_classify_bands,m_cohsex,m_exc_analyze,m_exc_build
!!      m_prep_calc_ucrpa,m_screening_driver,m_sigc,m_sigma_driver,m_sigx
!!      m_vhxc_me,m_wfd,m_wfk_analyze
!!
!! CHILDREN
!!      pawaccrhoij,pawcprj_alloc,pawcprj_free,pawio_print_ij
!!      pawrhoij_mpisum_unpacked,wfd_bks_distrb,wfd_get_cprj,wrtout
...
!!
!! PARENTS
!!      m_chi0,m_classify_bands,m_prep_calc_ucrpa,m_sigc,m_sigx,m_wfd
!!      m_wfk_analyze
!!
!! CHILDREN
!!      pawaccrhoij,pawcprj_alloc,pawcprj_free,pawio_print_ij
