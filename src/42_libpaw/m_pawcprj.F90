...
!!      m_paw_sym,m_pawcprj,m_positron,m_prep_calc_ucrpa,m_sigc,m_sigx,m_vtowfk
!!      m_wfd
!!
!! CHILDREN
!!      xmpi_sum
...
!!
!! PARENTS
!!      m_chebfi,m_dfpt_cgwf,m_dfpt_scfcv,m_getgh1c,m_invovl,m_scfcv_core
!!
!! CHILDREN
!!      xmpi_sum
!!
