...
!!      nhatgrid,nonlop_test,orbmag,pawcprj_getdim,pawmkrho,pawmkrhoij
!!      prtposcar,prtrhomxmn,scprqt,setnoccmmp,spin_current,timab
!!      total_energies,write_energies,wrtout,wvl_eigen_abi2big,wvl_mkrho
