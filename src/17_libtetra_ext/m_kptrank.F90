...
!!
!! PARENTS
!!      m_ddk,m_ebands,m_elphon,m_fstab,m_iogkk,m_kpts,m_nesting,m_phgamma
!!      m_pptools,m_tetrahedron
!!
!! CHILDREN
!!
!! SOURCE
...
! find smallest linear length
 ...
 TETRA_ALLOCATE(krank%rank, (nkpt))
...
!!
!! PARENTS
!!      m_ddk,m_double_grid,m_elphon,m_fstab,m_iogkk,m_kptrank,m_kpts,m_nesting
!!      m_pptools,m_tetrahedron
!!
!! CHILDREN
!!
...
!!
!! PARENTS
!!      defs_elphon,m_ddk,m_ebands,m_elphon,m_fstab,m_iogkk,m_kpts,m_nesting
!!      m_phgamma,m_pptools,m_tetrahedron
!!
!! CHILDREN
!!
!! SOURCE
