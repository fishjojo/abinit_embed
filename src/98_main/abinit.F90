...
!!      outxml_finalise,outxml_open,parsefile,print_kinds,setdevice_cuda
!!      specialmsg_getcount,status,testfi,timab,timana,time_set_papiopt,timein
!!      unsetdevice_cuda,wrtout,xmpi_init,xmpi_show_info,xmpi_sum
!!      xomp_show_info,xpapi_init,xpapi_show_info,xpapi_shutdown
!!
!! SOURCE
