#!/usr/bin/env python
# 
# use for ONLY for  abirules & buildsys tests ( in ./special dir )
#
import sys,os
...
testbot_cfg = pj(basedir,"../tests","testbot.cfg")
#print "testbot_cfg path = ",testbot_cfg
Results = dict()
Failed = False
##############################################################################
...
def MakeReport(f):
	...
	try:
		fname = "../tests/testbot_summary.shelve"
